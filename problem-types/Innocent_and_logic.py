def description(params):
	return '''
		...
		<ul style="padding-left: 40px; margin-top: 1em; margin-bottom: 1em;">
			...
			<li>если же за окном не жарко, то на улицу можно выйти если светит солнце или нет ветра, но если светит</li>
			<li>солнце и нет ветра одновременно, то Иннокентию лучше остаться дома.</li>
		</ul>
