...
def get_policy_pars():
	policy_pars = [
		{   'header': "1. Общие положения",
            'desc':  """<div> 1. Настоящая Политика конфиденциальности составлена в соответствии с требованиями Федерального закона
				от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных
				Оператором и меры по обеспечению безопасности персональных данных. </div><div> 2. Опе­ра­тор пер­со­наль­ных дан­ных ООО "Квантик", ИНН 7728344440 (далее – Опе­ра­тор) ста­вит важ­ней­шей 
				...
				личную и се­мей­ную тайну. </div><div> 3. Настоящая Политика конфиденциальности Оператора применяется ко всей информации, которую Оператор 
		...
		{   'header': "2. Термины и понятия",
            'desc':  """<div> 1. Персональные данные - любая информация, относящаяся к прямо или косвенно определенному 
				или определяемому физическому лицу (субъекту персональных данных); </div><div> 2. Предоставление персональных данных – действия, направленные на раскрытие персональных данных 
				определенному лицу или определенному кругу лиц; </div><div> 3. Настоящая Политика конфиденциальности Оператора применяется ко всей информации, которую Оператор 
				может получить о посетителях веб-сайта, размещенного в сети «Интернет» по адресу: <a href="https://www.kvantland.com"> https://
				www.kvantland.com</a></div><div> 4. Обработка персональных данных – любое действие (операция) или совокупность действий (операций), 
				...
				обезличивание, блокирование, удаление, уничтожение персональных данных; </div><div> 5. Автоматизированная обработка персональных данных – обработка персональных данных с помощью средств 
				вычислительной техники; </div><div> 6. Обезличивание персональных данных (уничтожение) – действия, в результате которых становится 
				невозможным определить принадлежность персональных данных конкретному субъекту персональных 
				данных;	</div><div> 7. Все действия по использованию Сайта, включая отправку любых сообщений, содержащих персональные 
				данные Пользователя через формы на сайте, возможны исключительно при наличии его свободного согласия 
				на обработку персональных данных в порядке, описанном в Политике. </div><div> 8. Отправляя свои персональные данные в форме обратной связи на сайте <a href="https://www.kvantland.com"> https://www.kvantland.com</a>, 
				Пользователь выражает согласие с условиями обработки персональных данных, предусмотренных 
				Политикой, и подтверждает, что: – он ознакомлен с Политикой, и данный документ ему понятен. </div><div> 9. Согласие Пользователя на обработку персональных данных может быть отозвано путем направления 
				...
				Пользователь обязан указать фамилию, имя и адрес электронной почты. </div><div> 10. Согласие на обработку персональных данных действует до достижения цели получения согласия, если иной 
				срок обработки не следует из требований законодательства РФ. </div><div> 11. При несогласии с любым указанным в Политике положением Пользователь обязан отказаться от совершения 
				действий на Сайте, для которых требуется использование Оператором его персональных данных. </div>"""},
		{   'header': "3. Цели обработки персональных данных",
            'desc':  """<div> 1. Оператор собирает данные, полученные от пользователей в процессе их регистрации и/или использования 
				...
				безопасности и устранения неполадок, а также предоставления поддержки. </div><div> 2. Цели использования Cookie-файлов («куки»-файлов). Файлы сookie представляют собой небольшие текстовые 
		...
		{   'header': "4. Состав персональных данных",
            'desc':  """<div> 1. Сведениями, составляющими персональные данные, является любая информация, относящаяся к прямо или 
				косвенно определенному или определяемому физическому лицу (субъекту персональных данных). </div><div> 2. Вы предоставляете некоторые из этих данных непосредственно, например, когда создаете учетную запись 
				...
				награждении победителей. </div><div> 3. В объем собираемых данных могут входить следующие: фамилия, имя, наименование и номер школы, номер 
		...
		{   'header': "5. Порядок обработки персональных данных",
            'desc':  """<div> 1. Обработка персональных данных осуществляется на основе принципов законности целей и способов 
				...
				обработки персональных данных. </div><div> 2. Персональные данные пользователей хранятся исключительно на электронных носителях и обрабатываются 
				с использованием автоматизированных систем, за исключением случаев, когда неавтоматизированная 
				обработка персональных данных необходима в связи с исполнением требований законодательства. </div><div> 3. Персональные данные Пользователей не передаются каким-либо третьим лицам. Предоставление 
				персональных данных пользователей по запросу государственных органов или органов местного самоуправ
				ления осуществляется в порядке, предусмотренном законодательством. </div><div> 4. Персональные данные пользователя уничтожаются при: удалении Оператором Аккаунта пользователя по его 
				запросу на электронную почту <a href="mailto:{config["contacts"]["support_email"]}">support@kvantland.com</a>. </div><div> 5. Оператор оставляет за собой право в автоматическом режиме удалять данные пользователя по истечении 
				одного календарного года со дня последнего посещения пользователем Сайта Оператора. </div>"""},
		{   'header': "6. Меры по защите персональных данных",
            'desc':  """<div> 1. Оператор принимает технические и организационно-правовые меры в целях обеспечения защиты 
				персональных данных Пользователя от неправомерного или случайного доступа к ним, уничтожения, 
				изменения, блокирования, копирования, распространения, а также от иных неправомерных действий </div><div> 2. Оператор определяет угрозы безопасности персональных данных при их обработке, формирует на их основе 
				...
				осуществляет установку и ввод в эксплуатацию средств защиты информации. </div><div> 3. Оператор проводит технические мероприятия, направленные на предотвращение несанкционированного 
				...
				постоянный контроль за обеспечением уровня защищенности персональных данных. </div><div> 4. Для разработки и осуществления мероприятий по обеспечению безопасности персональных данных при их 
		...
		{   'header': "7. Права и обязанности оператора и субъекта персональных данных",
            'desc':  """<div> 1. Оператор персональных данных вправе предоставлять персональные данные субъектов третьим лицам, если 
				...
				законодательством. </div><div> 2. Субъект персональных данных имеет право требовать уточнения своих персональных данных, их 
		...
		{   'header': "8. Заключительные положения",
            'desc':  """<div> 1. Настоящая Политика подлежит изменению или дополнению в случае появления новых законодательных 
				актов и специальных нормативных документов по обработке и защите персональных данных. </div><div> 2. Актуальная версия Политики расположена в свободном доступе в сети Интернет по адресу <a href="https://www.kvantland.com/policy"> https://
				kvantland.com/policy</a>. </div><div> 3. Все вопросы Пользователей по поводу настоящей Политики, а также запросы на уточнение, блокирование 
