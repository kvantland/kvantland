...
def display_starter():
	...
	yield f'<a class="contact_button" href="{config["contacts"]["youtube_link"]}" target="_blank"> <img class="contact_icon" loading="lazy" src="/static/design/icons/play.svg" /> </a>'
	yield f'<a class="contact_button" href="mailto:{config["contacts"]["support_email"]}" target="_blank" title="{config["contacts"]["support_email"]}"> <img class="contact_icon" loading="lazy" src="/static/design/icons/email.svg" /> </a>'
	yield '</div>'
