...
def get_tournament_history():
	...
	tournament_history['IT'] = [
		...
		{'event_name': 'Финиш Турнира 1', 'event_date': '30.12.2024'}
	]
...
def get_common_info_cards():
	info_cards = [
		{   'image': "screen.svg",
			'desc':  """ <span class="bold_text">Многие задачи интерактивны</span><br /><br />
						Для их решения потребуется компьютер с мышкой или тачпадом, чтобы 
						перетаскивать объекты и выделять клетки. Также потребуется любая 
						среда программирования для написания кода на Вашем любимом языке 
						(в турнире доступны Python, C, C++, Rust и многие другие)."""},
						
		{   'image': "clock.svg",
			'desc': """ <span class="bold_text">В турнире встречаются задачи разной сложности</span>
						<br /><br />
						Для решения задач рекомендуем выделить примерно 90
						минут"""},
		...
		{   'image': "planet.svg",
			'desc': """Примерно <span class="bold_text">3500 детей и взрослых из разных стран </span> 
						(Австралия, Болгария, Сербия, Россия, Казахстан, США, 
						Белоруссия и других) уже поучаствовали в турнирах по математике. 
						Давайте побьём этот рекорд вместе!"""},
						
		{   'image': "gift.svg",
			'desc': """Турнир индивидуальный и рассчитан на школьников 7-9 
						классов и младше. Победители турнира
						получат <span class="bold_text">призы от журнала 
						"Квантик"</span> """},
						
		{   'image': "medal.svg",
			'desc': """<span class="bold_text">В зачёт идет Ваш итоговый счёт в квантиках на 
						момент окончания турнира.</span> <br/> 
						<br/> Взрослые тоже могут участвовать, но в отдельном зачёте"""},
...
def get_team_cards():
	team_cards = [
...

		{
			...
			'id': "A_Lythenco",
			'name': "Антон Луценко",
			'desc': """Автор олимпиадных задач по программированию. Призёр заключительных 
						этапов Всероссийской олимпиады школьников по математике и информатике. 
						<br /> <br />
						Учитель информатики ФМШ №2007 (г. Москва), тренер сборной Москвы по математике. 
						Студент ФКН ВШЭ.""",
			'image': "A_Lythenco.png",
		},
		
		{
			...
			'desc': [
				{
					'title': "Редакторы",
					'team_members': ["А. Грибалко", "С. Полозков", "Г.Мерзон"]
				},
			]
		},

		{
			...
			'desc': [
				{
					'title': "IT",
					'team_members': ["Д. Чертоляс", "А. Луценко", "Д. Миронов"]
				},
			]
		},
