<template>
	<div>
		...
		<ul style="padding-left: 40px; margin-top: 1em; margin-bottom: 1em;">
			<li>если за окном жарко, то на улицу можно выйти, если светит солнце и нет или дождя, или ветра</li>
			<li>если же за окном не жарко, то на улицу можно выйти, если либо светит солнце, либо нет ветра (если светит
			солнце и нет ветра, то Иннокентию лучше остаться дома)</li>
		</ul>
