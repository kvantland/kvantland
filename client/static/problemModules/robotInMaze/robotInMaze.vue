	...
	<div class="game_plot">
		<div class="first_row">
			...
			<div class="description">
				<p><b>Соберите код, который поможет роботу дойти в клетку F и остановиться на ней.</b></p>
        ...
        <p> Если в процессе исполнения Вашей программы робот врезается в стену, то он мгновенно погибает. </p>
        <p> Если после завершения Вашей программы робот не останавливается в клетке F, новая попытка будет стоить \(1\) квантик. </p>
			</div>
			</ClientOnly>
		</div>
