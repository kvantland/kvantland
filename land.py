...
def show_land(db):
	...
	yield '<div class="span_wrapper span_text">Выберите время в течение месяца, чтобы вас ничего не отвлекало. Итоги соревнования подводятся по числу квантиков, которое у вас на счету к концу игры. Это число всегда отображается в вверху экрана по центру. Удачи!</div>'
	yield '</div>'
